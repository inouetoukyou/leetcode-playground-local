...
// 895. Friend Request
// Given an array Ages of length n, where the
// first i elements represent the age of the individual i.
// Find total number of friend requests sent
// by this n person. There are some requirements:
//
